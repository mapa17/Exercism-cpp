...
BOOST_AUTO_TEST_CASE(in_english_999)
{
    BOOST_REQUIRE_EQUAL("zero", say::in_english_999(0ULL));
    BOOST_REQUIRE_EQUAL("one", say::in_english_999(1ULL));
    BOOST_REQUIRE_EQUAL("ten", say::in_english_999(10ULL));
    BOOST_REQUIRE_EQUAL("eleven", say::in_english_999(11ULL));
    BOOST_REQUIRE_EQUAL("twenty-three", say::in_english_999(23ULL));
    BOOST_REQUIRE_EQUAL("one hundred", say::in_english_999(100ULL));
    BOOST_REQUIRE_EQUAL("three hundred twenty-five", say::in_english_999(325ULL));
    BOOST_REQUIRE_EQUAL("nine hundred ninety-nine", say::in_english_999(999ULL));
    BOOST_REQUIRE_THROW(say::in_english_999(1000ULL), std::domain_error);
}
